...
# occ
setwd("02_occ")
occ <- readr::read_csv("occ_spocc_filtro_taxonomico_data_espatial_limite.csv")
occ
...
readr::write_csv(occ_oppc, paste0("occ_spocc_filtro_taxonomico_data_espatial_limite_oppc.csv"))
